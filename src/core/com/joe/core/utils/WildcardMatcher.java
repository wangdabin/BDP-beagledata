...
/**
 * This class provides a method for the programmar to test whether a f ile
 * matches a wildcard.
 * 
 * For he who is familiar with dos, he will probably refer to files us ing
 * wildcard, that is file names like "*.bat","a?b.*",etc, this class gives you a
 * method to test if they are match.
 * 
 * A "*" can match any length of string including an empty string, A "?" can
 * match any single char.
 * 
 * So "abc" & "a*" matches "abc" & "*" matches "abc" & "b*" doesn"t match "abcd"
 * & "a*d" matches "abcd" & "a??d" matches ......
 */
...
public class WildcardMatcher {
	...
	public static void main(String[] args) {
		String source = "jack aha love aha rose aha!";
		String match = "j*";
		System.out.println(WildcardMatcher.match(source, match));
	}
