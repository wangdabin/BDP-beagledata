 ...
 * a sky-plugin, as well to the internationalizable resources and the plugin
...
public class PluginDescriptor {
  ...
  private String fPluginClass = SkyPlugin.class.getName();
  ...
  public static final Logger LOG = Logger.getLogger(PluginDescriptor.class);
   ...
   * @param pPath
   */
  public PluginDescriptor(String pId, String pVersion, String pName,String pType,
