...
class ParsePluginsReader {
  ...
  /* our log stream */
  public static final Logger LOG = Logger.getLogger(ParsePluginsReader.class);
   ...
   */
  public TestPluginList parse(Configuration conf) {
    
    TestPluginList pList = new TestPluginList();
    ...
    if (fParsePluginsFile != null) {
      ...
      ppInputStream = getClass().getResourceAsStream(
                          conf.getString(PP_FILE_PROP));
    }
  ...
  public static void main(String[] args) throws Exception {
    ...
    TestPluginList prefs = reader.parse(CoreConfigUtils.create());
